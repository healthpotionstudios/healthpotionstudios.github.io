...
//=====================================end matrix
    sendPixels()
    {
        ...
        renderer.DrawLine(this.projected[1][0],this.projected[1][1], this.projected[4][0],this.projected[4][1]);
        renderer.DrawLine(this.projected[2][0],this.projected[2][1], this.projected[4][0],this.projected[4][1]);
        renderer.DrawLine(this.projected[3][0],this.projected[3][1], this.projected[4][0],this.projected[4][1]);
